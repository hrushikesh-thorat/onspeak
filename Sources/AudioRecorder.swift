...
final class AudioRecorder: NSObject, ObservableObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let sessionQueue = DispatchQueue(label: "com.rushatpeace.onspeak.capture.session")
    private let sampleBufferQueue = DispatchQueue(label: "com.rushatpeace.onspeak.capture.samples")
