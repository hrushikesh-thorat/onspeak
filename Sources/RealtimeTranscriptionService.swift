...
private let realtimeLog = OSLog(subsystem: "com.rushatpeace.onspeak", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "com.rushatpeace.onspeak.realtime.state")
